                    ...
                    <div class="service-item position-relative h-100">
                        <div class="service-text rounded p-5">
                            <div class="btn-square bg-light rounded-circle mx-auto mb-4"
                                ...
                                <img class="img-fluid" src="<?= base_url()?>assets/landing/img/icon/icon-5.png" alt="Icon">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item position-relative h-100">
                        <div class="service-text rounded p-5">
                            <div class="btn-square bg-light rounded-circle mx-auto mb-4"
                                style="width: 64px; height: 64px;">
                                <img class="img-fluid" src="<?= base_url()?>assets/landing/img/icon/icon-6.png" alt="Icon">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item position-relative h-100">
                        <div class="service-text rounded p-5">
                            <div class="btn-square bg-light rounded-circle mx-auto mb-4"
                                style="width: 64px; height: 64px;">
                                <img class="img-fluid" src="<?= base_url()?>assets/landing/img/icon/icon-7.png" alt="Icon">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative h-100">
                        <div class="service-text rounded p-5">
                            <div class="btn-square bg-light rounded-circle mx-auto mb-4"
                                style="width: 64px; height: 64px;">
                                <img class="img-fluid" src="<?= base_url()?>assets/landing/img/icon/icon-8.png" alt="Icon">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item position-relative h-100">
                        <div class="service-text rounded p-5">
                            <div class="btn-square bg-light rounded-circle mx-auto mb-4"
                                style="width: 64px; height: 64px;">
                                <img class="img-fluid" src="<?= base_url()?>assets/landing/img/icon/icon-9.png" alt="Icon">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item position-relative h-100">
                        <div class="service-text rounded p-5">
                            <div class="btn-square bg-light rounded-circle mx-auto mb-4"
                                style="width: 64px; height: 64px;">
                                <img class="img-fluid" src="<?= base_url()?>assets/landing/img/icon/icon-10.png" alt="Icon">
                            </div>
            ...
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="<?= base_url()?>assets/landing/img/project-1.jpg" alt="">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="<?= base_url()?>assets/landing/img/project-2.jpg" alt="">
                        <div class="project-overlay">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="<?= base_url()?>assets/landing/img/project-3.jpg" alt="">
                        <div class="project-overlay">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="<?= base_url()?>assets/landing/img/project-4.jpg" alt="">
                        <div class="project-overlay">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="<?= base_url()?>assets/landing/img/team-1.jpg" alt="">
                        <h5>Alex Robin</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="<?= base_url()?>assets/landing/img/team-2.jpg" alt="">
                        <h5>Adam Crew</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="<?= base_url()?>assets/landing/img/team-3.jpg" alt="">
                        <h5>Boris Johnson</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="<?= base_url()?>assets/landing/img/team-4.jpg" alt="">
                        <h5>Robert Jordan</h5>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img class="mb-4" src="<?= base_url()?>assets/landing/img/testimonial-1.jpg" alt="">
                ...
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img class="mb-4" src="<?= base_url()?>assets/landing/img/testimonial-2.jpg" alt="">
                    <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et
                        sit, sed stet lorem sit clita duo justo</p>
                    <h5>Client Name</h5>
                    <span class="text-primary">Profession</span>
                ...
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img class="mb-4" src="<?= base_url()?>assets/landing/img/testimonial-3.jpg" alt="">
                    <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et
                        sit, sed stet lorem sit clita duo justo</p>
                    <h5>Client Name</h5>
                    <span class="text-primary">Profession</span>
                ...
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img class="mb-4" src="<?= base_url()?>assets/landing/img/testimonial-4.jpg" alt="">
                    <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et
                        sit, sed stet lorem sit clita duo justo</p>
                    <h5>Client Name</h5>
                    <span class="text-primary">Profession</span>
